...
Pmur_dist <- st_read("Input_files/Pmuralis_distribution/data_0.shp")
...
# Read in data set
freq_combined <- read.csv("Input_files/DataS1_220_Populations.csv") 
...
# Read in data set
data <- read.csv("Input_files/DataS2_148_Populations_ForGreenness.csv") 
